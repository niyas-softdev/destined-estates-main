      ...
      <div className="mx-auto max-w-2xl px-4 lg:max-w-7xl lg:px-6">
        <div className="max-w-4xl text-center lg:text-left mb-10 lg:mb-14">
          ...
          <p className="mt-4 text-xl leading-8 text-gray-300">
            ...
            Destined Estates&apos; experienced neighborhood real estate experts can help.
          </p>
        </div>
        ...
        <section className="mt-12 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-10 lg:gap-y-14">
          <div className="lg:pr-8">
            ...
            <p className="mt-4 text-base text-gray-300">
              In your neighborhood and across the city, nobody understands the residential
              real estate scene like Destined Estates. Whether you're buying, renting, or
              selling, when you connect with a Destined Estates professional, you're
            ...
            <p className="mt-4 text-base text-gray-300">
              Discover our international standards luxury real estate company and get to
              know one of the industry's most recognized and respected brand names. Our
              professionals specialize in market intelligence and client satisfaction.
            </p>
          </div>
