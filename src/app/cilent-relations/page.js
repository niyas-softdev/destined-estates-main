...
import ClientRelations from '@/components/pages/ClientRelations';
                ...
                <div className="relative w-full h-[250px] overflow-hidden mb-1">
                    <div className="relative w-full flex transition-transform ease-in-out duration-1000">
                        <div className="w-full flex-shrink-0">
                            <img src="/static/Assets/client1.jpg" alt="assets & solutions" className="w-full h-[300px] object-cover" />
                    ...
                    <div className="absolute inset-0 flex flex-col justify-center items-center text-white w-full px-4 lg:px-0">
                        <h1 className="text-5xl lg:text-5xl font-bold pt-10 text-center font-playfair pb-3 z-20">Client Relations</h1>
                    </div>
                </div>
            </div>
